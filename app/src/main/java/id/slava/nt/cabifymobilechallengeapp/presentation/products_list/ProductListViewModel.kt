...
import kotlinx.coroutines.launch
       ...
       class ProductListViewModel(private val getProductsUseCase: GetProductsUseCase) :
           ...
           private val _productsToBuy = mutableStateOf(listOf<Product>())
           val productsToBuy: State<List<Product>> = _productsToBuy
           ...
           fun addProductToBuy(product: Product) {
               _productsToBuy.value += product
           }
