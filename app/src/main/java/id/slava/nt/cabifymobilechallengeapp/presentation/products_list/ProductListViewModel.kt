...
class ProductListViewModel(
    ...
    private val calculateTotalWithDiscountUseCase: CalculateTotalWithDiscountUseCase,
    private val countSpecificItemsUseCase: CountSpecificItemsUseCase,
    ...
    fun calculateTotalWithDiscount(): Double {
        return discountRules.value?.let { rules ->
            calculateTotalWithDiscountUseCase(cart, rules)
        } ?: 0.0
    }
    ...
    fun countSpecificItems(): Map<String, Int> {
        return countSpecificItemsUseCase(cart)
    }
